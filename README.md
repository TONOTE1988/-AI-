...
### メイン画面
![メイン画面](docs/images/demo-main.png)
*RAGモードとAIエージェントモードの選択画面*

### チャット画面  
![チャット画面](docs/images/demo-chat.png)
*リアルタイムでストリーミング応答を表示*

### システム初期化
![初期化画面](docs/images/demo-init.png)
*議事録ファイルを自動読み込み、ベクターストア作成*

> **注意**: 実際の動作にはOpenAI APIキーが必要です。デモ用の無料体験版は現在準備中です。
